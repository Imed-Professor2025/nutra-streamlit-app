...
output_sdf_file = os.path.join(output_dir, "inactives_clean_conformers_validated.sdf")
output_excel_file = os.path.join(output_dir, "inactives_clean_conformers_validated_with_input_cols.xlsx")
