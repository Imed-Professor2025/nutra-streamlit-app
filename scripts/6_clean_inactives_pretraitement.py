...
def main():
    if len(sys.argv) != 3:
        print("Usage: python script6.py <input.sdf> <output_dir>")
        sys.exit(1)
    ...
    output_sdf = os.path.join(output_dir, "inactives_clean.sdf")
    ...
    report_path = os.path.join(output_dir, "report_script6.csv")
